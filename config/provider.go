...
import (
	...
	"github.com/tampakrap/provider-upjet-gcp-beta/config/accessapproval"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/accesscontextmanager"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/apigee"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/beyondcorp"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/bigquery"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/bigtable"
	composer "github.com/tampakrap/provider-upjet-gcp-beta/config/cloudcomposer"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/cloudfunctions"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/cloudplatform"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/cloudrun"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/cloudscheduler"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/cloudtasks"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/compute"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/container"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/containerattached"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/containeraws"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/containerazure"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/dataflow"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/dataproc"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/dns"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/endpoints"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/firebaserules"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/gameservices"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/gkehub"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/healthcare"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/iap"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/identityplatform"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/kms"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/logging"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/monitoring"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/notebooks"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/oslogin"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/privateca"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/project"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/pubsub"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/redis"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/secretmanager"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/servicenetworking"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/sourcerepo"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/spanner"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/sql"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/storage"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/tags"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/tpu"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/vertexai"
	"github.com/tampakrap/provider-upjet-gcp-beta/config/vpcaccess"
	"github.com/tampakrap/provider-upjet-gcp-beta/hack"
)

const (
	resourcePrefix = "gcp-beta"
	modulePath     = "github.com/tampakrap/provider-upjet-gcp-beta"
)
